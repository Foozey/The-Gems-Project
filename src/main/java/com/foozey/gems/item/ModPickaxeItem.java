...
public class ModPickaxeItem extends PickaxeItem {
    ...
    public ModPickaxeItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Function<UUID, Multimap<Attribute, AttributeModifier>> attributes, Properties properties) {
