...
public class ModHoeItem extends HoeItem {
    ...
    public ModHoeItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Function<UUID, Multimap<Attribute, AttributeModifier>> attributes, Properties properties) {
