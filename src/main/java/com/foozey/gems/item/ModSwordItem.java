...
public class ModSwordItem extends SwordItem {
    ...
    public ModSwordItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Function<UUID, Multimap<Attribute, AttributeModifier>> attributes, Properties properties) {
