...
public class ModShovelItem extends ShovelItem {
    ...
    public ModShovelItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, Function<UUID, Multimap<Attribute, AttributeModifier>> attributes, Properties properties) {
