...
public class EmeraldAmulet extends Item {

    public EmeraldAmulet(Properties properties) {
    ...
    public static final UUID AMULET_MOVEMENT_SPEED_UUID = UUID.fromString("daadee88-dbc4-11ea-87d0-0242ac130003");
        ...
        return new ICapabilityProvider() {
            private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(()-> new ICurio() {
                ...
                public Multimap<Attribute, AttributeModifier> getAttributeModifiers(String identifier) {
                    ...
                    modifiers.put(Attributes.MOVEMENT_SPEED, new AttributeModifier(AMULET_MOVEMENT_SPEED_UUID, "Movement Speed", 0.1, AttributeModifier.Operation.MULTIPLY_TOTAL));
                    return modifiers;
                }
