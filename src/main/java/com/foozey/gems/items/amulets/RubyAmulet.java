...
public class RubyAmulet extends Item {

    public RubyAmulet(Properties properties) {
        super(properties
                .stacksTo(1)
                .durability(250)
                .tab(ModTab.TAB_GEMS));
    ...
    public static final UUID AMULET_ATTACK_DAMAGE_UUID = UUID.fromString("8a3db07a-dbcc-11ea-87d0-0242ac130003");
        ...
        return new ICapabilityProvider() {
            private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(()-> new ICurio() {
                ...
                public Multimap<Attribute, AttributeModifier> getAttributeModifiers(String identifier) {
                    ...
                    modifiers.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(AMULET_ATTACK_DAMAGE_UUID, "Attack Damage", 2.00, AttributeModifier.Operation.ADDITION));
                    return modifiers;
                }
