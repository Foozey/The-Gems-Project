...
public class InfusedOnyxHoe extends HoeItem {
    ...
    public InfusedOnyxHoe(IItemTier p_i48460_1_, int p_i48460_2_, float p_i48460_3_, Properties p_i48460_4_) {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot, ItemStack stack) {
        ...
        if (item == ModItems.INFUSED_ONYX_HOE.get() && equipmentSlot == EquipmentSlotType.MAINHAND) {
