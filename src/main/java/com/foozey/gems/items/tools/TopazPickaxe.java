...
public class TopazPickaxe extends PickaxeItem {
    ...
    public TopazPickaxe(IItemTier p_i48478_1_, int p_i48478_2_, float p_i48478_3_, Properties p_i48478_4_) {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot, ItemStack stack) {
        ...
        if (item == ModItems.TOPAZ_PICKAXE.get() && equipmentSlot == EquipmentSlotType.MAINHAND) {
