...
public class SapphireSword extends SwordItem {
    ...
    public SapphireSword(IItemTier p_i48460_1_, int p_i48460_2_, float p_i48460_3_, Properties p_i48460_4_) {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot, ItemStack stack) {
        ...
        if (item == ModItems.SAPPHIRE_SWORD.get() && equipmentSlot == EquipmentSlotType.MAINHAND) {
