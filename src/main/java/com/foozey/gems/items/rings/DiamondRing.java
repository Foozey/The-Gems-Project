...
public class DiamondRing extends Item {
    ...
    public DiamondRing(Properties properties) {
    ...
    public static final UUID RING_ARMOR_TOUGHNESS_UUID = UUID.fromString("9c9ea57a-dbd2-11ea-87d0-0242ac130003");
        ...
        return new ICapabilityProvider() {
            private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(()-> new ICurio() {
                ...
                public Multimap<Attribute, AttributeModifier> getAttributeModifiers(String identifier) {
                    ...
                    modifiers.put(Attributes.ARMOR_TOUGHNESS, new AttributeModifier(RING_ARMOR_TOUGHNESS_UUID, "Armor Toughness", 2.00, AttributeModifier.Operation.ADDITION));
                    return modifiers;
                }
